...
class AddPetRepositoryImpl extends AddPetRepository {

  final ApiService _apiService = ApiService();
  @override
  Future<Either<Failure, BaseResponse<String>>> addPet(Map<String, dynamic> map) async {
    try {
      ...
      if (isConnected) {
        ...
        final response = await _apiService.post(
            endPoint: ApiConstants.addPet, data: map, headers: headers);
