...
class VetHomeRepositoryImpl extends VetHomeRepository {

  final ApiService _apiService = ApiService();

  @override
  Future<Either<Failure, BaseResponse<PetsResponseModel>>> getAppointments(Map<String, dynamic> map) async {
    try {
