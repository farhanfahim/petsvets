...
class RequestTile extends StatelessWidget {
  ...
  RequestTile({required this.model, this.onTap,});
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            Visibility(
                              visible: model.type == RequestType.both || model.type == RequestType.flag,
                      ...
                      Visibility(
                        visible: model.type == RequestType.both || model.type == RequestType.alert,
                        child: const CommonImageView(
                          svgPath: AppImages.alert,
                        ),
                      ),
                    ],
                  ),
