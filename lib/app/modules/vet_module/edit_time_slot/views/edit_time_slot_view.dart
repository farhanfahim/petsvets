...
import '../view_model/edit_time_slot_view_model.dart';

class EditTimeSlotView extends StatelessWidget {

  EditTimeSlotViewModel viewModel = Get.put(EditTimeSlotViewModel(repository: Get.find<SlotRepository>()));

  EditTimeSlotView({super.key});
